 ...
 * The interactive tool mounts here from Stage B (js/tools/content-to-course-sparker.js).
 */
...
$pageTitle = 'Content-to-Course Idea Sparker';
require __DIR__ . '/../inc/head.php';
?>
<div class="wrap" data-tool-root data-tool-slug="content-to-course-sparker" data-tool-gate="2">
  <div class="tool-shell">
    <div class="tool-shell__head">
      <span class="badge badge--studio">Studio Original</span>
      <h1>Content-to-Course Idea Sparker</h1>
    </div>
    <div class="tool-step">
