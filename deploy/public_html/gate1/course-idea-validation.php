<?php
/**
 * gate1/course-idea-validation.php
 * Server-side guard first: a locked gate returns a redirect, not a page.
 * The interactive tool mounts here from Stage B (js/tools/course-idea-validation.js).
 */
...
$pageTitle = 'Will It Sell? Validation Check';
require __DIR__ . '/../inc/head.php';
?>
<div class="wrap" data-tool-root data-tool-slug="course-idea-validation" data-tool-gate="1">
  <div class="tool-shell">
    <div class="tool-shell__head">
      <span class="badge badge--studio">Studio Original</span>
      <h1>Will It Sell? Validation Check</h1>
    </div>
    <div class="tool-step">
